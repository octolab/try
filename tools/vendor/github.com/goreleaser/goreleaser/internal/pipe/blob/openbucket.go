...
import (
	...
	_ "gocloud.dev/blob/s3blob" // import the secrets packages we want to be able to open:
	"gocloud.dev/secrets"       // Import the blob packages we want to be able to open.
